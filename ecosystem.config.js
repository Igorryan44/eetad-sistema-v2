// Configuração PM2 para EETAD Sistema v2
...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      'pre-deploy-local': '',
      'post-deploy': 'npm install && cd local-server && npm install && cd .. && npm run build && pm2 reload ecosystem.config.js --env production',
      'pre-setup': ''
    }
  }
};
